...
#x axis is zonal wind volecity, y axis is time, and colormap indicates height (alititude)
...
#x axis is time, y axis is height (alititude), and colormap indicates zonal wind volecity
plt.figure(figsize=(30,25))
...
plt.savefig('Zonal Wind Velocity, x axis= time, y axis= alititude.png')	#saves the figure in the present directory
plt.show()



#x axis is height (alititude),y axis is time, and colormap indicates zonal wind volecity
plt.figure(figsize=(30,25))
plt.title("Zonal Wind Velocity as a Function of Time and Altitude", fontsize='11')
...
plt.savefig('Zonal Wind Velocity, x axis= alititude,y axis= time.png')	#saves the figure in the present directory
plt.show()
